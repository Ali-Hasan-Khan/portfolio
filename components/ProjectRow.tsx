...
export default function ProjectRow({
  ...
  return (
    <div className="py-6 lg:py-7 border-b border-border first:border-t group transition-colors duration-150 hover:bg-surface -mx-4 px-4 lg:-mx-0 lg:px-0">
      <div className="grid grid-cols-1 lg:grid-cols-[48px_1fr_200px] gap-3 lg:gap-8 items-baseline">
        ...
        <div className="min-w-0">
          {/* Big thumbnail - clickable to external link */}
          <a
            href={externalLink}
            target="_blank"
            rel="noopener noreferrer"
            className="mb-4 block w-full aspect-video max-w-md bg-surface border border-border rounded-md overflow-hidden"
          >
            {project.image ? (
              <Image
                src={project.image}
