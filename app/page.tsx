    ...
    <div className="min-h-screen bg-black text-gray-300 flex justify-center font-mono">
      ...
      <div className="max-w-4xl mx-0 md:mx-auto md:ml-16 px-4 py-10 md:py-20">
        ...
        <div className="mt-10 sm:mt-20 md:mt-0 md:mb-0">
          ...
          <div className="mb-2">
            I'm a <span className="text-white font-semibold">Full Stack Web Developer</span> with a strong focus on both frontend and backend web development. I build functional, user-friendly digital experiences that balance design and engineering. Whether working with clients or <span className="text-white font-semibold">freelancing</span>, I'm always exploring new ways to create and innovate.
          </div>
            ...
            {Array.from({ length: 7 }).map((_, dayOfWeek) => (
              ...
              Array.from({ length: 52 }).map((_, week) => {
                ...
                return (
                  <div
                    key={index}
                    className={`md:w-3 md:h-3 w-1.5 h-1.5 rounded-sm ${contributionData.length === 0 ? 'bg-gray-900' :
        ...
        <div className="mb-16">
          <div className="text-gray-400 mb-4 text-center md:text-start">Technologies I work with</div>
        ...
        {/* Projects Section */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold mb-6 text-white text-center md:text-start">Projects</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-800 shadow-md shadow-slate-600 rounded-md p-6 bg-black/30 hover:bg-gray-900/30 transition-colors">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-semibold text-white">Whoscored-Scraper</h3>
        ...
        {/* Social Links */}
        <div className="mb-16">
          <div className="text-gray-400 mb-4 text-center md:text-start">You can check these links if you wish to</div>
          <div className="flex flex-wrap gap-2 justify-center md:justify-start">
