      ...
      <div className="max-w-4xl mx-0 md:mx-auto md:ml-16 px-4 py-10 md:py-20">
        ...
        <div className="mt-10 sm:mt-20 md:mt-0 md:mb-0">
          ...
          <div className="mb-2">
            ...
            always exploring new ways to create and innovate.
          </div>
            ...
            {Array.from({ length: 7 }).map((_, dayOfWeek) =>
              ...
              Array.from({ length: 52 }).map((_, week) => {
                ...
                return (
                  <div
                    key={index}
                    className={`md:w-3 md:h-3 w-1.5 h-1.5 rounded-sm ${
        ...
        <div className="mb-8 md:mb-16">
          <div className="relative">
            ...
            <div className="hidden md:flex items-center z-10 justify-between mb-6 px-0">
              ...
              <div className="w-3 h-3 ml-8 z-10 bg-gray-300 rounded-full flex-shrink-0"></div>
            ...
            <div
              className="md:hidden absolute left-[21px] top-4 bottom-0"
              style={{
                width: "2px",
                background:
                  "linear-gradient(180deg, rgba(255,255,255,0.8) 0%, rgba(75,85,99,1) 15%, rgba(31,41,55,1) 100%)",
            ...
            <div
              className="hidden md:block absolute top-1.5 left-4 right-8 h-0.5"
              style={{
                top: "0.375rem",
                clipPath: "polygon(0 0, 100% 0, 85% 100%, 0 100%)",
                background:
                  "linear-gradient(90deg, rgba(255,255,255,0.8) 0%, rgba(75,85,99,1) 15%, rgba(31,41,55,1) 100%)",
              }}
            ></div>

            {/* Timeline Items - Responsive Grid */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-2 mt-0">
              {/* Item 1 - Current */}
              <div className="flex items-start relative">
                <div className="md:hidden w-3 h-3 absolute left-4 top-4 bg-white rounded-full z-10"></div>
                <div className="flex flex-row md:flex-col items-center md:items-start pl-12 md:pl-0">
              ...
              <div className="flex items-start relative">
                ...
                <div className="flex flex-row md:flex-col items-center md:items-start pl-12 md:pl-0">
                  ...
                  <div>
                    ...
                    <div className="text-gray-500 text-sm">Jan 2026 - June 2026</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="text-gray-400 mb-4 text-center md:text-start">
        ...
        <div className="mb-16" id="projects">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-800 shadow-md shadow-slate-600 rounded-md p-6 bg-black/30 hover:bg-gray-900/30 transition-colors">
              ...
              <p className="text-gray-400 mb-4">
                A personal memory vault that lets users write letters to their
                future selves, capture special moments, and receive AI-generated
                summaries of their emotional journey.
              </p>
              ...
              <div className="flex space-x-4">
                <Link
                  href="https://github.com/Ali-Hasan-Khan/pastel"
                  target="_blank"
                  className="text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                >
                  <FiGithub />
            ...
            <div className="border border-gray-800 shadow-md shadow-slate-600 rounded-md p-6 bg-black/30 hover:bg-gray-900/30 transition-colors">
              ...
              <div className="flex space-x-4">
                <Link
                  href="https://github.com/Ali-Hasan-Khan/EduManager"
                  target="_blank"
                  className="text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                >
                  <FiGithub />
            ...
            <div className="border border-gray-800 shadow-md shadow-slate-600 rounded-md p-6 bg-black/30 hover:bg-gray-900/30 transition-colors">
              ...
              <p className="text-gray-400 mb-4">
                A sophisticated web scraping tool that extracts and visualizes
                football match data from Whoscored.com using Selenium and
                mplsoccer library.
              </p>
            ...
            <div className="border border-gray-800 shadow-md shadow-slate-600 rounded-md p-6 bg-black/30 hover:bg-gray-900/30 transition-colors">
              ...
              <p className="text-gray-400 mb-4">
                A robust banking service system built in Go, enabling account
                creation, balance management, and currency handling with secure
              ...
              <div className="flex space-x-4">
                <Link
                  href="https://github.com/Ali-Hasan-Khan/go-bankify"
                  target="_blank"
                  className="text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                >
                  <FiGithub />
            ...
            <div className="border border-gray-800 shadow-md shadow-slate-600 rounded-md p-6 bg-black/30 hover:bg-gray-900/30 transition-colors">
              <div className="flex items-center gap-3 mb-3">
                <img
                  src="/dialogue-logo.png"
                  alt="Dialogue Summarizer Logo"
                  className="w-8 h-8 rounded-md"
                />
                <h3 className="text-xl font-semibold text-white">
                  Dialogue Summarizer
              ...
              <div className="flex space-x-4">
                <Link
                  href="https://github.com/Ali-Hasan-Khan/dialogue-summarizer"
                  target="_blank"
                  className="text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                >
                  <FiGithub />
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 text-sm mb-4 md:mb-0 text-center md:text-start">
